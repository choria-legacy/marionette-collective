...
%{__install} -m0755 mcollectived.rb %{buildroot}%{_sbindir}/mcollectived
...
%{__install} -m0755 mcollective.init-rh %{buildroot}%{_sysconfdir}/init.d/mcollective
%if 0%{?suse_version}
...
cp mc-* %{buildroot}%{_sbindir}
cp mco %{buildroot}%{_bindir}
...
%files client
%attr(0755, root, root)%{_sbindir}/mc*
...
%changelog
* Mon Sep 12 2011 Michael Stahnke <stahnma@puppetlabs.com> - 1.2.1-2
- Update Spec file for EPEL/RH guidelines
